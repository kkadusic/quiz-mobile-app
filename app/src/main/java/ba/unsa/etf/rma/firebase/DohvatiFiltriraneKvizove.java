...
public class DohvatiFiltriraneKvizove extends AsyncTask<String, Void, Void> {
    ...
    public DohvatiFiltriraneKvizove(IDohvatiFilterKvizoveDone p, Resources r, Kategorija kategorija) {
        poziv = p;
        resources = r;
